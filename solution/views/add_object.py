...
class AddObjectView(Frame):
    def __init__(self, *args, **kwargs):
        ...
        self.headTxt = Label(header, text="Add Object", font="Courier 16 bold", bg="#003300", fg="#FFFFFF")
        self.headTxt.grid(row=0, column=0, sticky="nsew")

        form = Frame(container, bd=4, bg="#BEBDB8")
        form.columnconfigure([0, 4], weight=1)
        form.rowconfigure([0, 3], weight=1)
        form.grid(row=1, column=1, sticky="nsew")

        # create text box labels
        self.object_name_label = Label(form, text="Object Name:", font="Courier 10 bold", fg="#003300", bg="#BEBDB8")
        self.object_name_label.grid(row=1, column=1, pady=15)

        self.object_name = Entry(form, width=30)
        self.object_name.grid(row=1, column=2, padx=5, sticky="ew")
