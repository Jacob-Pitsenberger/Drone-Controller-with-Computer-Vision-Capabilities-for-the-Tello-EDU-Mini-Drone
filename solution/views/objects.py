...
Date: 4/28/2023
Purpose: This module contains the ObjectsView class which is displayed in the Main window
         when the user selects the Objects menu item.
Uses: N/A
"""

from tkinter import Frame, Label, Button

class ObjectsView(Frame):
    def __init__(self, *args, **kwargs):
        ...
        self.headTxt = Label(header, text="Objects", font="Courier 16 bold", bg="#003300", fg="#FFFFFF")
